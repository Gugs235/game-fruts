...
export const LEVELS: LevelDef[] = [
  ...
  {
    id: "4",
    name: "Prateleira Alta",
    world: "fridge",
    intro: "Os itens estão nos dois lados da estante — escolha por onde passar.",
    map: [
      "###############",
      "#P............#",
      "#.............#",
    ...
    objective: {
      waves: [
        { item: "banana", count: 4 },
        { item: "blueberry", count: 3, moving: true },
      ],
    },
  },
  {
    id: "5",
    name: "Combinação Gelada",
    world: "fridge",
    intro: "Gomas vigiam a sala fria dos dois lados. Use seu poder pra abrir caminho.",
    map: [
      "###############",
      "#P..#.....#..o#",
      "#...#.....#...#",
  ...
  },
  {
    ...
    objective: {
      waves: [{ item: "cherry", count: 4, moving: true }],
    },
  },
  {
    id: "7",
  ...
  {
    id: "9",
    name: "Corredor dos Pirulitos",
    world: "pantry",
    intro: "Pirulitos quebram caixas dos dois lados — não conte só com paredes.",
    map: [
      "###############",
      "#P.#.......#..#",
      "#..#..XXX..#.o#",
  ...
  {
    id: "10",
    name: "Sala das Caixas Gêmeas",
    world: "pantry",
    intro: "Gomas e pirulitos truncam o caminho. Organize suas rotas com cuidado.",
    map: [
      "###############",
      "#P....#..#...o#",
      "#.....#..#....#",
  ...
  },
  {
    ...
    name: "Eco Duplo",
    world: "freezer",
    intro: "Duas rotas, duas ameaças. A gelatina lembra seus últimos passos — planeje-os.",
    map: [
      "###############",
      "#P.....#.....o#",
      "#......#......#",
  ...
  {
    id: "15",
    name: "Câmara Final do Gelo",
    world: "freezer",
    intro: "O ápice do freezer: ecos, gomas e caixas por todo lado. Domine o ritmo.",
    map: [
      "###############",
      "#P............#",
      "#..XXX...XXX..#",
