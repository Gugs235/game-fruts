...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BZJtd3Uf.js
var router_BZJtd3Uf_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-CkHOWdyn.css";
var APP_NAME = "Fruit Rebellion";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Jogo 2D top-down de labirinto: frutas heróicas contra o Rei do Açúcar."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-DdHtCBkS.mjs");
...
//#endregion
export { getRouter, router_BZJtd3Uf_exports as t };
